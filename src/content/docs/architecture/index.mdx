...
- **[Clean Architecture](/architecture/general/clean-architecture):** Biznes logikani markazga qo'yuvchi va uni tashqi detallardan himoya qiluvchi yondashuv.

### 2. Frontend

Foydalanuvchi interfeysini (UI) qurishda ishlatiladigan patternlar.

- **[MVC](/architecture/frontend/mvc) (Model-View-Controller):** Klassik ajratish usuli.
- **[MVVM](/architecture/frontend/mvvm) (Model-View-ViewModel):** Data-binding ga asoslangan (Vue, Angular).
- **[MVP](/architecture/frontend/mvp) (Model-View-Presenter):** View va Model ni to'liq ajratish.
- **[Flux](/architecture/frontend/flux):** Bir tomonlama ma'lumot oqimi (React/Redux).
- **[Atomic Design](/architecture/frontend/atomic-design):** UI komponentlarini qurish metodologiyasi.
- **[FSD](/architecture/frontend/fsd) (Feature-Sliced Design):** Katta frontend loyihalar uchun qatlamli arxitektura.

### 3. Backend

Server tomonida ishlatiladigan, tizimlar o'rtasidagi aloqa va ma'lumotlarni qayta ishlashga qaratilgan patternlar.

- **[Microservices](/architecture/backend/microservices):** Kichik, mustaqil xizmatlar to'plami.
- **[Hexagonal Architecture](/architecture/backend/hexagonal):** Tashqi dunyo bilan aloqani portlar va adapterlar orqali boshqarish.
- **[CQRS](/architecture/backend/cqrs):** O'qish va yozish operatsiyalarini ajratish.
- **[Event-Driven](/architecture/backend/event-driven):** Hodisalarga asoslangan asinxron aloqa.
